...
class Hand():
    ...
    # One pair := 1
    # High card := 0
    ranking: dict[str, int] = {"2":0,"3":1,"4":2,"5":3,"6":4,"7":5,"8":6,"9":7,"T":8,"J":-1,"Q":10,"K":11,"A":12}
    ...
    def get_type(self) -> int:
        ...
        while index < len(card_copy):
            if card_copy[index] != card_copy[index-1] and card_copy[index] != 'J':
                card_amount.append(1)
            elif card_copy[index] != 'J':
        ...
        print(f"{reduce(lambda x1,x2: f'{x1}{x2}', self.cards)} -> {card_amount} -> {number_of_jokers}")

        if len(card_amount) == 0:
            return 6
        ...
        if card_amount[0] == 3:
            ...
            if number_of_jokers == 1:
                return 5
            if number_of_jokers == 0 and card_amount[1] == 2:
                return 4
            return 3
        if card_amount[0] == 2 :
            ...
            if number_of_jokers == 2:
                return 5
            if number_of_jokers == 1 and card_amount[1] == 2:
                return 4
            if number_of_jokers == 1 and card_amount[1] == 1:
                return 3
            if number_of_jokers == 0 and card_amount[1] == 2:
                return 2
            return 1
